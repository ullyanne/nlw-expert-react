    ...
    return(
        <Dialog.Root>
            ...
            <Dialog.Portal>
                ...
                <Dialog.Content className='fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 overflow-hidden max-w-[640px] h-[60vh] w-full bg-slate-700 rounded-md flex flex-col outline-none'>
